...
def new_cvs ():
    finance_tracker= open("finance_traker.csv", "a") #create and open new file .csv
    finance_tracker.write("Date")
    finance_tracker.write(",")
    finance_tracker.write("Category")
    finance_tracker.write(",")
    finance_tracker.write("Description")
    finance_tracker.write(",")
    finance_tracker.write("Amount")
    finance_tracker.write(",")
    finance_tracker.write("Type")
    finance_tracker.write(",")
    finance_tracker.write("\n")
